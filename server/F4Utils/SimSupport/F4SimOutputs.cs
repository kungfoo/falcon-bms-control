namespace F4Utils.SimSupport
{
    ...
    {
        MAP__OWNSHIP_POSITION__FEET_NORTH_OF_MAP_ORIGIN,
        MAP__OWNSHIP_POSITION__FEET_EAST_OF_MAP_ORIGIN,
        MAP__OWNSHIP_POSITION__LATITUDE,
        MAP__OWNSHIP_POSITION__LONGITUDE,
        MAP__BULLSEYE_POSITION__FEET_NORTH_OF_MAP_ORIGIN,
        MAP__BULLSEYE_POSITION__FEET_EAST_OF_MAP_ORIGIN,
        MAP__GROUND_SPEED_VECTOR__NORTH_COMPONENT_FPS,
        MAP__GROUND_SPEED_VECTOR__EAST_COMPONENT_FPS,
        MAP__GROUND_SPEED_KNOTS,

        TRUE_ALTITUDE__MSL,
        RADAR_ALTIMETER__ALTITUDE__AGL,
        RADAR_ALTIMETER__RALT_VALID,
        ...
        SIM__DRAWING_DATA_VERSION_NUM,
        SIM__STRING_DATA_VERSION_NUM,

        SIM__BMS_EXE,
        SIM__BMS_BASE_DIRECTORY,
        SIM__BMS_BIN_DIRECTORY,
        SIM__BMS_UI_ART_DIRECTORY,
        SIM__BMS_USER_DIRECTORY,
        SIM__BMS_ACMI_DIRECTORY,
        SIM__BMS_BRIEFINGS_DIRECTORY,
        SIM__BMS_LOGS_DIRECTORY,
        SIM__BMS_CONFIG_DIRECTORY,
        SIM__BMS_PATCH_DIRECTORY,
        SIM__BMS_PICTURE_DIRECTORY,

        SIM__BMS_3DBUTTONS_FILE,
        SIM__BMS_3DCOCKPIT_FILE,

        THEATER__THEATER_NAME,
        THEATER__CAMPAIGN_DIRECTORY,
        THEATER__ART_DIRECTORY,
        THEATER__MOVIE_DIRECTORY,
        THEATER__UI_SOUND_DIRECTORY,
        THEATER__OBJECT_DIRECTORY,
        THEATER__3D_DATA_DIRECTORY,
        THEATER__MISC_TEX_DIRECTORY,
        THEATER__SOUND_DIRECTORY,
        THEATER__TAC_REF_DIRECTORY,
        THEATER__SPLASH_DIRECTORY,
        THEATER__COCKPIT_DIRECTORY,
        THEATER__SIM_DATA_DIRECTORY,
        THEATER__SUBTITLES_DIRECTORY,
        THEATER__TAC_REF_PICS_DIRECTORY,

        SIM_KEYFILE_PATH, 

        AIRCRAFT_NAME,
        AIRCRAFT_NCTR_DESIGNATION,


        SIM__BMS_VERSION,
        SIM__STRING_AREA_SIZE,
        SIM__DRAWING_AREA_SIZE,
        ...
        VOICE_MESSAGE_SYSTEM__ALL_WORDS,
        VOICE_MESSAGE_SYSTEM__PULL_UP,
        VOICE_MESSAGE_SYSTEM__ALTITUDE,
        VOICE_MESSAGE_SYSTEM__WARNING,
        VOICE_MESSAGE_SYSTEM__JAMMER,
        VOICE_MESSAGE_SYSTEM__COUNTER,
        VOICE_MESSAGE_SYSTEM__CHAFFFLARE,
        VOICE_MESSAGE_SYSTEM__CHAFFFLARE_LOW,
        VOICE_MESSAGE_SYSTEM__CHAFFFLARE_OUT,
        VOICE_MESSAGE_SYSTEM__LOCK,
        VOICE_MESSAGE_SYSTEM__CAUTION,
        VOICE_MESSAGE_SYSTEM__BINGO,
        VOICE_MESSAGE_SYSTEM__DATA,
        VOICE_MESSAGE_SYSTEM__IFF,
        VOICE_MESSAGE_SYSTEM__LOWSPEED,
        VOICE_MESSAGE_SYSTEM__BEEPS,
        VOICE_MESSAGE_SYSTEM__AOA,
        VOICE_MESSAGE_SYSTEM__MAXG,

        ICP__BINGO_FUEL_LEVEL,
        ICP__CARA_ALOW,

        HUD__DRAWING_COMMANDS_LENGTH,
        HUD__DRAWING_COMMANDS,

        RWR__DRAWING_COMMANDS_LENGTH,
