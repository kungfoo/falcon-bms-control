...
namespace Common.UI.Wizard
{
    ...
    public class WizardPage : Panel
    {
        ...
        /// <summary>
        ///     Event called before this page is closed when the back button is pressed. If you don't want to show pageIndex -1
        ///     then
        ...
        /// <summary>
        ///     Event called before this page is closed when the next button is pressed. If you don't want to show pageIndex -1
        ///     then
        ///     set page to be the new page that you wish to show
        /// </summary>
