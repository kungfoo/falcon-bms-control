namespace Common.Drawing.Imaging
{
    ...
    {
        /// <summary>
        ///     The pixel data contains color-indexed values, which means the values are an index to colors in the system
        ///     color table, as opposed to individual color values.
        /// </summary>
        Indexed = 65536,
        ...
        /// <summary>
        ///     The default pixel format of 32 bits per pixel. The format specifies 24-bit color depth and an 8-bit alpha
        ///     channel.
        /// </summary>
        Canonical = 2097152,
        ...
        /// <summary>
        ///     Specifies that the pixel format is 1 bit per pixel and that it uses indexed color. The color table therefore
        ///     has two colors in it.
        /// </summary>
        ...
        /// <summary>
        ///     The pixel format is 16 bits per pixel. The color information specifies 32,768 shades of color, of which 5 bits
        ///     are red, 5 bits are green, 5 bits are blue, and 1 bit is alpha.
        /// </summary>
