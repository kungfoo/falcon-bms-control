namespace Common.Drawing.Drawing2D
{
    ...
    {
        /// <summary>
        ///     Specifies that when a color is rendered, it is blended with the background color. The blend is determined by
        ///     the alpha component of the color being rendered.
        /// </summary>
        SourceOver,
