...
{
    /// <summary>
    ///     The <see cref="T:Common.Drawing.Drawing2D.InterpolationMode" /> enumeration specifies the algorithm that is
    ///     used when images are scaled or rotated.
    /// </summary>
    public enum InterpolationMode
    {
        /// <summary>
        ///     Equivalent to the <see cref="F:Common.Drawing.Drawing2D.QualityMode.Invalid" /> element of the
        ///     <see cref="T:System.Drawing.Drawing2D.QualityMode" /> enumeration.
        /// </summary>
        Invalid = -1,
        ...
        /// <summary>
        ///     Specifies bilinear interpolation. No prefiltering is done. This mode is not suitable for shrinking an image
        ///     below 50 percent of its original size.
        /// </summary>
        Bilinear,

        /// <summary>
        ///     Specifies bicubic interpolation. No prefiltering is done. This mode is not suitable for shrinking an image
