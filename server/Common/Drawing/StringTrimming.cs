namespace Common.Drawing
{
    ...
    public enum StringTrimming
    {
        ...
        /// <summary>
        ///     Specifies that the text is trimmed to the nearest character, and an ellipsis is inserted at the end of a
        ///     trimmed line.
        /// </summary>
        EllipsisCharacter,
        ...
        /// <summary>
        ///     The center is removed from trimmed lines and replaced by an ellipsis. The algorithm keeps as much of the last
