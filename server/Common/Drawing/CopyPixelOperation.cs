...
{
    /// <summary>
    ///     Determines how the source color in a copy pixel operation is combined with the destination color to result in
    ///     a final color.
    /// </summary>
    ...
    {
        /// <summary>
        ///     The destination area is filled by using the color associated with index 0 in the physical palette. (This color
        ///     is black for the default physical palette.)
        /// </summary>
        Blackness = 66,

        /// <summary>
        ///     Windows that are layered on top of your window are included in the resulting image. By default, the image
        ///     contains only your window. Note that this generally cannot be used for printing device contexts.
        /// </summary>
        ...
        ///     the destination are using the Boolean XOR operator.
        /// </summary>
        PatInvert = 5898313,
        ...
        /// <summary>
        ///     The destination area is filled by using the color associated with index 1 in the physical palette. (This color
