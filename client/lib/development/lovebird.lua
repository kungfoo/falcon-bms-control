...
function lovebird.init()
  ...
  for k, page in pairs(lovebird.pages) do
    lovebird.pages[k] = lovebird.template(page, "lovebird, req", "pages." .. k)
  end
...
function lovebird.trace(...)
  ...
  print(str)
  if not lovebird.wrapprint then
    lovebird.print(str)
  end
end
...
function lovebird.checkwhitelist(addr)
  if lovebird.whitelist == nil then
    return true
  end
